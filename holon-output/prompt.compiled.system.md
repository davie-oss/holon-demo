...
Solve mode is the default Holon execution mode. The agent works autonomously to implement changes and produce outputs.

Use the common contract rules without modification.
